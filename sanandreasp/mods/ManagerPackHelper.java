...
public class ManagerPackHelper
{
    ...
    public void initMan(SAPConfigManager cfgman, SAPLanguageManager langman,
            SAPUpdateManager updman)
    {
    ...
    private int checkVersion(String currVer, String expectedVer)
    {
        ...
        int majDiff =
                Integer.parseInt(currSplit[0]) - Integer.parseInt(exptSplit[0]);
        int minDiff =
                Integer.parseInt(currSplit[1]) - Integer.parseInt(exptSplit[1]);
        int revDiff =
                (currSplit.length < 3 ? 0 : Integer.parseInt(currSplit[2]))
