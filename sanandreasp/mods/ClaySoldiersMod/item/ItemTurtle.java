...
public class ItemTurtle extends Item
	{
		...
		public boolean spawnTurtle(World par0World, int par1, double par2,
				double par4, double par6)
			{
				EntityTurtle var8 =
						new EntityTurtle(par0World, par2, par4, par6, par1);
				...
				if (j == 0)
					{
						...
						else if (i == 5) { return 0x222222; // Endstone
						}
						return 0x553322;
					}
				else
					{
						...
						else if (i == 6) { return 0xd07c14; // Pumpkin
						}
						return 0x553322;
					}
			}
		...
		public void registerIcons(IconRegister par1IconRegister)
			{
				this.itemIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:dollTurtle");
				this.sndIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:dollShell");
			}
