...
public class ItemHorses extends Item
	{
		...
		public boolean spawnHorse(World par0World, int par1, double par2,
				double par4, double par6)
			{
				EntityHorse var8 =
						new EntityHorse(par0World, par2, par4, par6, par1);
				if (horseType == 1)
		...
		public int getColorFromItemStack(ItemStack is, int j)
			{
				...
				if (j > 0 && horseType == 1)
				...
				else
					{
						...
						else if (i == 7) { return 0xFF7700; // carrot
						}
						return 0x553322;
					}
			}
		...
		public void registerIcons(IconRegister par1IconRegister)
			{
				this.itemIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:dollHorse");
				this.sndIcon =
						par1IconRegister.registerIcon("ClaySoldiersMod:wing");
			}
