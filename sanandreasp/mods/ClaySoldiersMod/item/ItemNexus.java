...
public class ItemNexus extends Item
	{
		...
		public boolean spawnNexus(World par0World, int par1, double par2,
				double par4, double par6)
			{
				EntityClayNexus var8 =
						new EntityClayNexus(par0World, par4, par6, par1);
		...
		public void registerIcons(IconRegister par1IconRegister)
			{
				this.itemIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:dollNexus");
			}
	}
