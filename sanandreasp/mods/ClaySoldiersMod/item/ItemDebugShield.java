...
public class ItemDebugShield extends ItemGlobal
	{
		...
		public void registerIcons(IconRegister par1IconRegister)
			{
				this.itemIcon =
						par1IconRegister.registerIcon("ClaySoldiersMod:shield");
				this.studdedIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:shields");
				this.starIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:starfruitSlice");
				this.studStarIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:starfruitStuds");
