...
public class ItemGecko extends Item
	{
		...
		public boolean spawnGecko(World par0World, int par1, double par2,
				double par4, double par6)
			{
				EntityGecko var8 =
						new EntityGecko(par0World, par2, par4, par6, par1);
		...
		public String getUnlocalizedName(ItemStack itemstack)
			{
				...
				epona +=
						getTypeName(getTypes(i)[0]) + "-"
								+ getTypeName(getTypes(i)[1]);
		...
		private int getTypeColorWood(int i)
			{
				switch (i)
					{
						case 1:
							return 0xcfe3ba; // Birch
						case 2:
							return 0x50361a; // Pine
						case 3:
							return 0x393d0d; // Jungle
						default:
							return 0x7f6139; // Oak
					}
			}
		...
		private int getTypeColorLeaves(int i)
			{
				switch (i)
					{
						case 1:
							return 0xa2c978; // Birch
						case 2:
							return 0x395a39; // Pine
						case 3:
							return 0x378020; // Jungle
						default:
							return 0x378020; // Oak
					}
			}
		...
		public void registerIcons(IconRegister par1IconRegister)
			{
				this.itemIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:dollGeckoBody");
				this.scndTexture =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:dollGeckoSpots");
			}
	}
