...
public class ItemBunny extends Item
	{
		...
		public boolean spawnBunny(World par0World, int par1, double par2,
				double par4, double par6)
			{
				EntityBunny var8 =
						new EntityBunny(par0World, par2, par4, par6, par1);
		...
		public void registerIcons(IconRegister par1IconRegister)
			{
				this.itemIcon =
						par1IconRegister
								.registerIcon("ClaySoldiersMod:dollBunny");
			}
