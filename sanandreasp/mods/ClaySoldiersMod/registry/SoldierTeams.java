...
public class SoldierTeams
	{
		public static final Map<Integer, SoldierTeams> soldiers = Maps
				.newHashMap();
		...
		public static void initDefTeams()
			{
				...
				new SoldierTeams(16, "claysoldiersmod:dollMelon",
						"Melon Soldier", false);
				new SoldierTeams(17, "claysoldiersmod:dollPumpkin",
						"Pumpkin Soldier", false);
		...
		public static void addCustomTeam(int id, String dollIcon, String name,
				ResourceLocation[] teamTexture)
			{
				...
				SoldierTeams.soldiers.put(id + 4096, new SoldierTeams(
						id + 4096, dollIcon, name, true, teamTexture));
			}
		...
		private static class SoldierStats
			{
				...
				public SoldierStats(String name, String iconName,
						ResourceLocation[][] teamTex, float hlt, float atk,
						float wlk)
					{
