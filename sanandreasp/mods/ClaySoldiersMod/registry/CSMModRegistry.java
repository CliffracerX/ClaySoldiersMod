...
@Mod(modid = CSMModRegistry.modID, name = "Clay Soldiers Mod",
		version = "2.0.0",
		dependencies = "after:sanandreasp.core.manpack.ManPackLoadingPlugin")
@NetworkMod(clientSideRequired = true, serverSideRequired = false,
		clientPacketHandlerSpec = @SidedPacketHandler(
				channels = CSMModRegistry.channelID,
				packetHandler = PacketHandlerClient.class),
		serverPacketHandlerSpec = @SidedPacketHandler(
				channels = CSMModRegistry.channelID,
				packetHandler = PacketHandlerCommon.class))
public class CSMModRegistry
	{
		...
		public static final String proxyCmn =
				"sanandreasp.mods.ClaySoldiersMod.registry.CommonProxy";
		public static final String proxyClt =
				"sanandreasp.mods.ClaySoldiersMod.client.registry.ClientProxy";
		
		@Instance("ClaySoldiersMod")
		public static CSMModRegistry instance;
		
		@SidedProxy(clientSide = CSMModRegistry.proxyClt,
				serverSide = CSMModRegistry.proxyCmn)
		...
		private void setIDs()
			{
				String[] itemNames =
						new String[]
							{
									"disruptor", "soldierDoll", "horseDoll",
									"pegasusDoll", "brickDoll", "clayCookie",
									"turtleDoll", "bunnyDoll", "geckoDoll",
									"shield", "clayNexus", "shearBlade",
									"brickLump", "arenaPlacer", "upgshield"
							};
		...
		public void preInit(FMLPreInitializationEvent event)
			{
				...
				manHelper
						.initMan(
								new SAPConfigManager("ClaySoldiersMod",
										"ClaySoldiers.txt", "/sanandreasp/"),
								new SAPLanguageManager(
										"/sanandreasp/ClaySoldiers/", "1.0",
										"Clay Soldiers Mod"),
								new SAPUpdateManager(
										"Clay Soldiers Mod",
										2,
										0,
										0,
										"http://dl.dropbox.com/u/56920617/ClaySoldiersMod2_latest.txt",
										"http://www.minecraftforum.net/topic/964897-"));
				...
				// Items
				clayDisruptor =
						(new ItemClayDisruptor(itemIDs[0] - 256))
								.setUnlocalizedName("claydisruptor")
								.setCreativeTab(this.claySoldierTab);
				greyDoll =
						(new ItemClayMan(itemIDs[1] - 256, 0))
								.setUnlocalizedName("claydoll").setCreativeTab(
										this.claySoldierTab);
				horseDoll =
						(new ItemHorses(itemIDs[2] - 256, 0))
								.setUnlocalizedName("horsedoll")
								.setCreativeTab(this.claySoldierTab);
				pegasusDoll =
						(new ItemHorses(itemIDs[3] - 256, 1))
								.setUnlocalizedName("pegasusdoll")
								.setCreativeTab(this.claySoldierTab);
				bunnyDoll =
						(new ItemBunny(itemIDs[4] - 256)).setUnlocalizedName(
								"bunnydoll")
								.setCreativeTab(this.claySoldierTab);
				geckoDoll =
						(new ItemGecko(itemIDs[5] - 256)).setUnlocalizedName(
								"geckodoll")
								.setCreativeTab(this.claySoldierTab);
				brickDoll =
						(new ItemGlobal(itemIDs[6] - 256))
								.setIconFile("ClaySoldiersMod:dollBrick")
								.setUnlocalizedName("brickDoll")
								.setCreativeTab(this.claySoldierTab);
				clayCookie =
						(new ItemGlobal(itemIDs[7] - 256))
								.setIconFile("ClaySoldiersMod:noms")
								.setUnlocalizedName("clayCookie")
								.setCreativeTab(this.claySoldierTab);
				turtleDoll =
						(new ItemTurtle(itemIDs[8] - 256)).setUnlocalizedName(
								"clayturtle").setCreativeTab(
								this.claySoldierTab);
				shield =
						(new ItemDebugShield(itemIDs[9] - 256))
								.setUnlocalizedName("clayshield");
				upgshield =
						(new ItemUpgradeShield(itemIDs[10] - 256))
								.setUnlocalizedName("clayshield");
				nexus =
						(new ItemNexus(itemIDs[11] - 256)).setUnlocalizedName(
								"claynexus")
								.setCreativeTab(this.claySoldierTab);
				shearBlade =
						(new ItemGlobal(itemIDs[12] - 256))
								.setIconFile("ClaySoldiersMod:shearBlade")
								.setUnlocalizedName("clayShearBlade")
								.setCreativeTab(this.claySoldierTab);
				brickLump =
						(new ItemGlobal(itemIDs[13] - 256))
								.setIconFile("ClaySoldiersMod:brickLump")
								.setUnlocalizedName("brickLump")
								.setCreativeTab(this.claySoldierTab);
				arenaPlacer =
						(new ItemArenaPlacer(itemIDs[14] - 256))
								.setUnlocalizedName("arenaPlacer")
								.setCreativeTab(this.claySoldierTab);
			}
		...
		public void init(FMLInitializationEvent event)
			{
				...
				NetworkRegistry.instance().registerGuiHandler(instance,
						new GuiHandler());
				TickRegistry.registerTickHandler(new Handler_ServerTicks(),
						Side.SERVER);
				if (FMLCommonHandler.instance().getSide().isClient())
					TickRegistry.registerTickHandler(new Handler_ClientTicks(),
							Side.CLIENT);
				// claySoldierTab.setBackgroundImageName(this.CSMTAB_TEXTURE);
				
				// Dispenser handler
				BlockDispenser.dispenseBehaviorRegistry.putObject(greyDoll,
						new Handler_BehaviorDispenseItem());
				BlockDispenser.dispenseBehaviorRegistry.putObject(horseDoll,
						new Handler_BehaviorDispenseItem());
				BlockDispenser.dispenseBehaviorRegistry.putObject(pegasusDoll,
						new Handler_BehaviorDispenseItem());
				BlockDispenser.dispenseBehaviorRegistry.putObject(bunnyDoll,
						new Handler_BehaviorDispenseItem());
				BlockDispenser.dispenseBehaviorRegistry.putObject(turtleDoll,
						new Handler_BehaviorDispenseItem());
				BlockDispenser.dispenseBehaviorRegistry.putObject(geckoDoll,
						new Handler_BehaviorDispenseItem());
				
				EntityRegistry.registerModEntity(EntityClayMan.class,
						"CSM_ClaySoldier", 0, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityGravelChunk.class,
						"CSM_GravelChunk", 1, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntitySnowball.class,
						"CSM_SnowChunk", 2, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityFireball.class,
						"CSM_FireChunk", 3, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityHorse.class,
						"CSM_ClayHorse", 4, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityPegasus.class,
						"CSM_ClayPegasus", 5, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityBunny.class,
						"CSM_Bunny", 6, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityTurtle.class,
						"CSM_ClayTurtle", 7, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityGecko.class,
						"CSM_Gecko", 8, this, 64, 1, true);
				EntityRegistry.registerModEntity(EntityClayNexus.class,
						"CSM_ClayNexus", 9, this, 64, 1, true);
		...
		public void postInit(FMLPostInitializationEvent evt)
			{
				...
				manHelper.getLangMan().addLangProp(clayDisruptor,
						"Clay Disruptor");
				manHelper.getLangMan().addLangProp(brickDoll,
						"Lifeless Brick Doll");
				...
				manHelper.getLangMan().addLangProp("itemGroup.ClaySoldiers",
						"Clay Soldier Items");
				
				// String soldierNames[] = new String[] {
				// "Clay Soldier", "Red Soldier", "Yellow Soldier",
				// "Green Soldier", "Blue Soldier",
				// "Orange Soldier", "Purple Soldier", "Pink Soldier",
				// "Brown Soldier", "White Soldier",
				// "Black Soldier", "Cyan Soldier", "Light Grey Soldier",
				// "Lime Soldier", "Light Blue Soldier",
				// "Magenta Soldier", "Melon Soldier", "Pumpkin Soldier",
				// "Coal Soldier", "Redstone Soldier"
				// };
				String horseNames[] =
						new String[]
							{
									"Dirt Horse", "Sand Horse", "Gravel Horse",
									"Snow Horse", "Grass Horse", "Lapis Horse",
									"Clay Horse", "Carrot Horse"
							};
				String pegasiNames[] =
						new String[]
							{
									"Dirt Pegasus", "Sand Pegasus",
									"Gravel Pegasus", "Snow Pegasus",
									"Grass Pegasus", "Lapis Pegasus",
									"Clay Pegasus", "Carrot Pegasus"
							};
				String bunnyNames[] =
						new String[]
							{
									"White Bunny", "Orange Bunny",
									"Magenta Bunny", "Light Blue Bunny",
									"Yellow Bunny", "Lime Bunny", "Pink Bunny",
									"Gray Bunny", "Light Gray Bunny",
									"Cyan Bunny", "Purple Bunny", "Blue Bunny",
									"Brown Bunny", "Green Bunny", "Red Bunny",
									"Black Bunny"
							};
				String turtleNames[] =
						new String[]
							{
									"Stone Turtle", "Mossy Turtle",
									"Netherrack Turtle", "Melon Turtle",
									"Sandstone Turtle", "Endstone Turtle",
									"Pumpkin Turtle"
							};
				...
				for (int sldInd : SoldierTeams.getTeamsList().keySet())
					if (sldInd < 4096)
						manHelper
								.getLangMan()
								.addLangProp(
										greyDoll.getUnlocalizedName(new ItemStack(
												greyDoll, 1, sldInd))
												+ ".name",
										SoldierTeams.getTeamsList().get(sldInd).localName);
				int i;
				for (i = 0; i < horseNames.length; i++)
					manHelper.getLangMan().addLangProp(
							horseDoll.getUnlocalizedName(new ItemStack(
									horseDoll, 1, i)) + ".name", horseNames[i]);
				for (i = 0; i < pegasiNames.length; i++)
					manHelper.getLangMan().addLangProp(
							pegasusDoll.getUnlocalizedName(new ItemStack(
									pegasusDoll, 1, i)) + ".name",
							pegasiNames[i]);
				for (i = 0; i < bunnyNames.length; i++)
					manHelper.getLangMan().addLangProp(
							bunnyDoll.getUnlocalizedName(new ItemStack(
									bunnyDoll, 1, i)) + ".name", bunnyNames[i]);
				for (i = 0; i < turtleNames.length; i++)
					manHelper.getLangMan().addLangProp(
							turtleDoll.getUnlocalizedName(new ItemStack(
									turtleDoll, 1, i)) + ".name",
							turtleNames[i]);
				
				String geckoPrefix[] = new String[]
					{
							"Oakwood", "Birchwood", "Pinewood", "Junglewood"
					};
				
				for (i = 0; i < 16; i++)
					manHelper.getLangMan().addLangProp(
							geckoDoll.getUnlocalizedName(new ItemStack(
									geckoDoll, 1, i)) + ".name",
							getGeckoNameFromIndex(i, geckoPrefix, 0));
				...
				GameRegistry.addRecipe(new ItemStack(greyDoll, 4, 0), "$", "#",
						'$', Block.slowSand, '#', Block.blockClay);
				
				GameRegistry.addRecipe(new ItemStack(brickDoll, 4, 0), "$",
						"#", '$', Block.slowSand, '#', Block.brick);
				
				ItemStack horsePegasiMaterial[] =
						new ItemStack[]
							{
									...
									new ItemStack(Block.tallGrass, 1,
				...
				for (i = 0; i < horsePegasiMaterial.length; i++)
					{
						...
						GameRegistry.addRecipe(
								new ItemStack(pegasusDoll, 2, i), " @ ", "#$#",
								"# #", '$', Block.slowSand, '#',
								horsePegasiMaterial[i], '@', Item.feather);
					}
				
				GameRegistry.addRecipe(new ItemStack(clayDisruptor, 1, 0),
						"#$#", "#@#", '$', Item.stick, '#', Item.clay, '@',
						Item.redstone);
				
				ItemStack turtleMaterial[] =
						new ItemStack[]
							{
				...
				GameRegistry.addSmelting(greyDoll.itemID, new ItemStack(
						brickDoll, 1), 0F);
				...
				GameRegistry.addShapelessRecipe(new ItemStack(Item.shears, 1),
						new ItemStack(shearBlade, 1), new ItemStack(shearBlade,
								1));
				
				GameRegistry.addShapelessRecipe(new ItemStack(clayCookie, 16),
						new ItemStack(Item.clay, 1), new ItemStack(Item.sugar,
								1));
				...
				for (i = 0; i < soldierDyeIndex.length; i++)
					{
						GameRegistry.addShapelessRecipe(new ItemStack(greyDoll,
								1, i + 1), new Object[]
							{
									new ItemStack(greyDoll, 1),
				...
				GameRegistry.addShapelessRecipe(new ItemStack(greyDoll, 1, 0),
						new ItemStack(brickDoll, 1), new ItemStack(
								Item.ghastTear, 1));
				
				GameRegistry.addShapelessRecipe(new ItemStack(greyDoll, 4, 16),
						new ItemStack(greyDoll, 1), new ItemStack(greyDoll, 1),
						new ItemStack(greyDoll, 1), new ItemStack(greyDoll, 1),
				...
				GameRegistry.addShapelessRecipe(new ItemStack(greyDoll, 1, 16),
						new ItemStack(greyDoll, 1), new ItemStack(
								Item.melonSeeds, 1));
				...
				GameRegistry
						.addShapelessRecipe(new ItemStack(greyDoll, 1, 18),
								new ItemStack(greyDoll, 1), new ItemStack(
										Item.coal, 1));
				...
				for (i = 0; i < 20; i++)
					{
						GameRegistry.addRecipe(new ItemStack(greyDoll, 8, 0),
								"###", "#X#", "###", '#', new ItemStack(
										greyDoll, 1, i), 'X', new ItemStack(
										Item.bucketWater, 1));
						GameRegistry.addShapelessRecipe(new ItemStack(greyDoll,
								1, 0), new ItemStack(greyDoll, 1, i),
				...
				for (i = 0; i < geckoMaterial.length; i++)
					{
						for (int j = 0; j < geckoMaterial.length; j++)
							{
								int dmg = i * 4 + j;
								GameRegistry.addRecipe(new ItemStack(geckoDoll,
										2, dmg), "1", "2", "3", '1',
										geckoMaterial[i], '2', new ItemStack(
												Block.slowSand, 1), '3',
										geckoMaterial[j]);
							}
					}
				
				GameRegistry.addRecipe(new ItemStack(nexus, 1), "CDC", "SOS",
						"OOO", 'C', new ItemStack(Item.clay, 1), 'D',
						new ItemStack(Item.diamond, 1), 'S', new ItemStack(
								Block.slowSand, 1), 'O', new ItemStack(
								Block.obsidian, 1));
				
				GameRegistry.addShapelessRecipe(new ItemStack(Item.brick, 1),
						new ItemStack(this.brickLump, 1));
			}
		
		private String getGeckoNameFromIndex(int ind, String[] prefStrings,
				int lang)
			{
				int x = 0, y = 0;
