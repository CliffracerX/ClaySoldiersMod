...
public interface IUpgradeItem
	{
		/**
		 * The pickup method for the upgrade. Fired everytime a soldier tries to
		 * pick up an item.
		 **/
		...
		/**
		 * The attack method for the upgrade. Fired every time a soldier hits
		 * something.
		 **/
		...
		/**
		 * The target method for the upgrade. Fired every time a soldier targets
		 * something.
		...
		/**
		 * The target method for the upgrade. Fired every time a soldier gets
		 * targeted.
		 * Return null if you want to prevent targeting.
		 **/
		...
		/**
		 * The break method for the upgrade. Fired once a soldier breaks its
		 * upgrade.
		 **/
		public void onBreak(IUpgradeEntity entity, Random rnd);
		
		/**
		 * The ItemStack which is supposed to be the upgrading item. Will be
		 * collected by the soldier.
		 **/
		public ItemStack getItemStack(IUpgradeEntity attacker);
		
		/**
		 * The ItemStack which shall be held when the soldier is upgraded.
		 * Return null for no held item.
		 * CLIENT-SIDE ONLY!
		 **/
		@SideOnly(Side.CLIENT)
		...
		/**
		 * A check for the soldier if the upgrade is compatible with another
		 * upgrade.
		 **/
