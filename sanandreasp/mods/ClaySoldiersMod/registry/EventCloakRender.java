...
public class EventCloakRender
{
    ...
    private final String serverLocation = "https://raw.github.com/CliffracerX/ClaySoldierMod/master/capes.txt";
    ...
    {
        if (Loader.isModLoaded("shadersmod") || CSMModRegistry.capesEnabled==false)
        {
            return;
        }
        ...
        try
        {
            ...
            while ((str = br.readLine()) != null)
            {
                if (!str.startsWith("--"))
                {
                    ...
                    {
                        System.err.println("[CSM] [skins.txt] Syntax error on line " + linetracker + ": " + str);
                    }
                }
                linetracker++;
            }
