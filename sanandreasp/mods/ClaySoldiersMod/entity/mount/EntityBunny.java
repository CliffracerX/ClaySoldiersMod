...
public class EntityBunny extends EntityCreature implements IMount
	{
		...
		public void setAltSkin(boolean b)
			{
				...
				this.dataWatcher.updateObject(20, (byte) (b ? (byt | 1)
						: (byt & ~1)));
			}
		...
		public void updateEntityActionState()
			{
				if (riddenByEntity == null
				...
				else
					{
						...
						// isJumping = rider.isJumping() ||
						// handleWaterMovement();
						this.isJumping = true;
						moveForward =
								rider.getMoveForward() * rider.getSpeedMulti();
						moveStrafing =
								rider.getMoveStrafing() * rider.getSpeedMulti();
		...
		public void writeToNBT(NBTTagCompound nbttagcompound)
			{
				...
				nbttagcompound.setShort("bunnyColor",
		...
		public void readFromNBT(NBTTagCompound nbttagcompound)
			{
				...
				this.dataWatcher.updateObject(19,
						nbttagcompound.getShort("bunnyColor"));
		...
		protected String getHurtSound()
			{
				worldObj.playSoundAtEntity(this, "step.cloth", 0.6F,
		...
		public EntityItem entityDropItem(ItemStack par1ItemStack, float par2)
			{
				return spawnedFromNexus ? null : super.entityDropItem(
						par1ItemStack, par2);
			}
		...
		public boolean attackEntityFrom(DamageSource damagesource, float i)
			{
				...
				if (this.getHealth() - i <= 0 && rand.nextInt(25) == 0
