		...
		public void updateEntityActionState()
			{
				...
				if (!onGround && riddenByEntity != null
								...
								if (ec.getFollowEntity() != null)
									{
										double a =
												ec.posX
														- ec.getFollowEntity().posX;
										double b =
												ec.posZ
														- ec.getFollowEntity().posZ;
										double d = Math.sqrt((a * a) + (b * b));
										
										if (d <= 1.75D
												&& ec.boundingBox.minY > (ec
														.getFollowEntity().posY - 1.0D))
											{
												plunge = true;
											}
									}
								if (ec.getEntityToAttack() != null)
									{
										double a =
												ec.posX
														- ec.getEntityToAttack().posX;
										double b =
												ec.posZ
														- ec.getEntityToAttack().posZ;
										double d = Math.sqrt((a * a) + (b * b));
										
										if (d <= 1.75D
												&& ec.boundingBox.minY > (ec
														.getEntityToAttack().posY - 1.0D))
											{
												plunge = true;
											}
									}
						...
						if (moveForward != 0.0F && !plunge)
							{
								if (onGround)
								...
								else
									{
										...
										int k1 =
												MathHelper
														.floor_double(boundingBox.minY - 0.5D);
										int l1 = MathHelper.floor_double(posZ);
										if ((worldObj.getBlockId(j, i1 - 1, l1) != 0 || worldObj
												.getBlockId(j, k1 - 1, l1) != 0)
												&& worldObj.getBlockId(j,
														i1 + 2, l1) == 0
												&& worldObj.getBlockId(j,
														i1 + 1, l1) == 0)
											{
