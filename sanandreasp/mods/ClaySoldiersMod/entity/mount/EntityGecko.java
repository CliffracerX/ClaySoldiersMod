...
public class EntityGecko extends EntityCreature implements IMount
	{
		...
		// String epona =
		// "/sanandreasp/mods/ClaySoldiersMod/claymans/gecko/gecko";
		...
		public void updateEntityActionState()
			{
				if (riddenByEntity == null
				...
				else
					{
						...
						// moveForward = rider.getMoveForward() *
						// (rider.getSpeedMulti()) * moveSpeed;
						// moveStrafing = rider.getMoveStrafing() *
						// (rider.getSpeedMulti()) * moveSpeed;
		...
		public void readFromNBT(NBTTagCompound nbttagcompound)
			{
				...
				setType(nbttagcompound.getShort("Type1"),
						nbttagcompound.getShort("Type2"));
		...
		protected String getHurtSound()
			{
				worldObj.playSoundAtEntity(this, "step.wood", 0.6F,
