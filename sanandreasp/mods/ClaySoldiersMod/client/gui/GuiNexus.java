		...
		private static ResourceLocation textures[] = new ResourceLocation[]
			{
					new ResourceLocation("claysoldiersmod",
							"textures/guis/NexusGUI1.png"),
					new ResourceLocation("claysoldiersmod",
							"textures/guis/NexusGUI2.png")
			};
		
		public GuiNexus(EntityPlayer player, EntityClayNexus par2Nexus,
				boolean active)
			{
		...
		public void initGui()
			{
				...
				GuiButton items1 =
						new GuiButton(0, l - 40, i1, 40, 20, "Items");
				GuiButton config =
						new GuiButton(1, l - 40, i1 + 20, 40, 20, "Config");
				...
				if (site == 1)
					{
						waveDurationSecTxt =
								new GuiTextField(fontRenderer, l + 10,
										110 + i1, 30, 15);
						waveDurationSecTxt.setText(Integer.toString(nexus
								.getWaveDurSec()));
						spawnSoldiersMaxTxt =
								new GuiTextField(fontRenderer, l + 10,
										110 + i1 + 20, 30, 15);
						spawnSoldiersMaxTxt.setText(Integer.toString(nexus
								.getMaxSpwnSoldiers()));
						maxLivingSoldiersTxt =
								new GuiTextField(fontRenderer, l + 10,
										110 + i1 + 40, 30, 15);
						maxLivingSoldiersTxt.setText(Integer.toString(nexus
								.getMaxLvngSoldiers()));
						randNoneItemsTxt =
								new GuiTextField(fontRenderer, l + 10,
										110 + i1 + 60, 30, 15);
						randNoneItemsTxt.setText(Integer.toString(nexus
								.getChanceGetNone()));
						maxHealthTxt =
								new GuiTextField(fontRenderer, l + 10,
										110 + i1 + 80, 30, 15);
						maxHealthTxt.setText(Integer.toString((int) nexus
								.getMaxHealth()));
						
						GuiButton heal =
								new GuiButton(2, l + 115, i1 + 20, 50, 20,
										"Heal");
						heal.enabled =
								(int) nexus.getHealth() < (int) nexus
										.getMaxHealth();
						buttonList.add(heal);
						
						GuiButton restore =
								new GuiButton(3, l + 115, i1 + 45, 50, 20,
										"Restore");
						restore.enabled = nexus.isDestroyed();
						buttonList.add(restore);
						
						GuiButton rnditems =
								new GuiButton(4, l + 115, i1 + 70, 50, 20,
										"Toggle");
						buttonList.add(rnditems);
					}
				
				GuiButton done =
						new GuiButton(5, l - 50, i1 + ySize - 20, 50, 20,
								"Done");
				buttonList.add(done);
			}
		...
		protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
			{
				...
				fontRenderer.drawString(s,
						l + (xSize / 2) - (fontRenderer.getStringWidth(s) / 2),
						i1 + 5, 0x606060);
				...
				if (site == 0)
					{
						...
						s = "Soldier";
						fontRenderer.drawString(s, l + 27, i1 + 26
								+ fontRenderer.FONT_HEIGHT, 0x303030);
						s = "Mount";
						fontRenderer.drawString(s, l + 117, i1 + 26
								+ fontRenderer.FONT_HEIGHT, 0x303030);
					}
				else if (site == 1)
					{
						...
						s = "In Seconds";
						fontRenderer.drawString(s, l + 45, 110 + i1
								+ fontRenderer.FONT_HEIGHT, 0x303030);
						
						this.spawnSoldiersMaxTxt.drawTextBox();
						s = "Spawned Soldiers";
						fontRenderer.drawString(s, l + 45, 20 + 110 + i1,
								0x303030);
						s = "Each Spawn";
						fontRenderer.drawString(s, l + 45, 20 + 110 + i1
								+ fontRenderer.FONT_HEIGHT, 0x303030);
						...
						fontRenderer.drawString(s, l + 45, 40 + 110 + i1,
								0x303030);
						s = "On Field";
						fontRenderer.drawString(s, l + 45, 40 + 110 + i1
								+ fontRenderer.FONT_HEIGHT, 0x303030);
						...
						s = "Random Value For";
						fontRenderer.drawString(s, l + 45, 60 + 110 + i1,
								0x303030);
						...
						s = "Max. Health For";
						fontRenderer.drawString(s, l + 45, 80 + 110 + i1,
								0x303030);
						s = "Clay Nexus";
						fontRenderer.drawString(s, l + 45, 80 + 110 + i1
								+ fontRenderer.FONT_HEIGHT, 0x303030);
						...
						s =
								"Health: "
										+ Integer
												.toString((int) ((ContainerNexus) inventorySlots).nexus
														.getHealth())
										+ "HP / "
										+ Integer
												.toString((int) ((ContainerNexus) inventorySlots).nexus
														.getMaxHealth()) + "HP";
						fontRenderer.drawString(s, l + 10, i1 + 17
								+ fontRenderer.FONT_HEIGHT, 0x303030);
						
						s =
								((ContainerNexus) inventorySlots).nexus
										.isDestroyed() ? "\2474Destroyed!"
										: "\2472not Destroyed";
						fontRenderer.drawString(s, l + 10, i1 + 17 + 25
								+ fontRenderer.FONT_HEIGHT, 0xFFFFFF);
						
						s = "Random Item Choice:";
						fontRenderer.drawString(s, l + 10, i1 + 17 + 48
								+ fontRenderer.FONT_HEIGHT, 0x303030);
						
						s =
								((ContainerNexus) inventorySlots).nexus
										.hasRandItems() ? "\2472enabled"
										: "\2474disabled";
						fontRenderer.drawString(s, l + 10 + 5, i1 + 17 + 48
								+ fontRenderer.FONT_HEIGHT * 2, 0xFFFFFF);
					}
				
				((GuiButton) buttonList.get(2)).enabled =
						(int) nexus.getHealth() < (int) nexus.getMaxHealth();
			}
				...
				if (site == 1)
					{
						...
						if (this.waveDurationSecTxt.getText().matches(
								"[0-9]{1,3}"))
							{
								int i =
										Integer.valueOf(this.waveDurationSecTxt
												.getText());
								if (i > 255)
									i = 255;
								if (i < 1)
						...
						if (this.spawnSoldiersMaxTxt.getText().matches(
								"[0-9]{1,3}"))
							{
								int i =
										Integer.valueOf(this.spawnSoldiersMaxTxt
												.getText());
								if (i > 255)
									i = 255;
								if (i < 1)
						...
						if (this.maxLivingSoldiersTxt.getText().matches(
								"[0-9]{1,3}"))
							{
								int i =
										Integer.valueOf(this.maxLivingSoldiersTxt
												.getText());
								if (i > 255)
									i = 255;
								if (i < 1)
						...
						if (this.randNoneItemsTxt.getText().matches(
								"[0-9]{1,3}"))
							{
								int i =
										Integer.valueOf(this.randNoneItemsTxt
												.getText());
								if (i > 255)
									i = 255;
								if (i < 0)
						...
						if (this.maxHealthTxt.getText().matches("[0-9]{1,3}"))
							{
								int i =
										Integer.valueOf(this.maxHealthTxt
												.getText());
								if (i > 255)
									i = 255;
								if (i < 1)
										...
										new byte[]
											{
													...
													(byte) nexus
															.getChanceGetNone(),
													(byte) nexus.getHealth(),
													(byte) nexus.getMaxHealth()
											});
		...
		protected void actionPerformed(GuiButton par1GuiButton)
			{
				...
				if (par1GuiButton.id == 1 && site == 0)
					{
						...
						inventorySlots =
								new ContainerNexus(
										((ContainerNexus) prevInvSlots).playerInv,
										((ContainerNexus) prevInvSlots).nexus,
										false);
						// ((CSM_ContainerNexus)this.inventorySlots).isActive =
						// false;
						// mc.thePlayer.closeScreen();
						// mc.thePlayer.openGui(CSM_ModRegistry.instance, 1,
						// serverNexus.worldObj,
						// MathHelper.ceiling_double_int(serverNexus.posX-0.5D),
						// MathHelper.ceiling_double_int(serverNexus.posY-0.5D),
						// MathHelper.ceiling_double_int(serverNexus.posZ-0.5D));
					}
						...
						if (par1GuiButton.id == 0)
							{
								site = 0;
								// inventorySlots = new
								// CSM_ContainerNexus(mc.thePlayer.inventory,
								// serverNexus, true);
								inventorySlots = prevInvSlots;
								// inventorySlots = new
								// CSM_ContainerNexus(mc.thePlayer.inventory,
								// ((CSM_ContainerNexus)this.inventorySlots).nexus,
								// true);
								// mc.thePlayer.openGui(CSM_ModRegistry.instance,
								// 0, mc.theWorld,
								// MathHelper.ceiling_double_int(serverNexus.posX-0.5D),
								// MathHelper.ceiling_double_int(serverNexus.posY-0.5D),
								// MathHelper.ceiling_double_int(serverNexus.posZ-0.5D));
				...
				Packet250CustomPayload packet =
						new Packet250CustomPayload("ClaySoldiers", new byte[]
							{
									entityIDByte[0], entityIDByte[1],
									entityIDByte[2], entityIDByte[3], (byte) 1,
									(byte) nexus.getHealth(),
									(byte) (nexus.isDestroyed() ? 1 : 0),
									(byte) (nexus.hasRandItems() ? 1 : 0)
							});
