...
public class RenderSnowball extends Render
	{
		private Item itemitemIcon;
		
		public RenderSnowball(Item i)
			{
				itemitemIcon = i;
			}
		...
		public void doRender(Entity entity, double d, double d1, double d2,
				float f, float f1)
			{
				...
				this.func_77026_a(tessellator,
						this.itemitemIcon.getIconFromDamage(0));
		...
		private void func_77026_a(Tessellator par1Tessellator, Icon par2Icon)
			{
				...
				GL11.glRotatef(180.0F - this.renderManager.playerViewY, 0.0F,
						1.0F, 0.0F);
				GL11.glRotatef(-this.renderManager.playerViewX, 1.0F, 0.0F,
						0.0F);
				...
				par1Tessellator.addVertexWithUV((double) (f4 - f5),
						(double) (f4 - f6), 0.0D, (double) f1, (double) f2);
				par1Tessellator.addVertexWithUV((double) (0.0F - f5),
