...
public class RenderGravelChunk extends Render
	{
		...
		public void doRenderItem(EntityGravelChunk entitygravelchunk, double d,
				double d1, double d2, float f, float f1)
			{
				...
				float f2 =
						MathHelper
								.sin((entitygravelchunk.entityAge + f1) / 10F);
						...
						for (int j = 0; j < byte0; j++)
							{
								...
								renderBlocks.renderBlockAsItem(
										...
										entitygravelchunk.getBrightness(f1));
								GL11.glPopMatrix();
							}
		...
		private void renderQuad(Tessellator tessellator, int i, int j, int k,
				int l, int i1)
			{
		...
		public void renderTexturedQuad(int i, int j, int k, int l, int i1,
				int j1)
			{
				float f = 0.0F;
				...
				tessellator.startDrawingQuads();
				tessellator.addVertexWithUV(i + 0, j + j1, f, (k + 0) * f1,
						(l + j1) * f2);
				tessellator.addVertexWithUV(i + i1, j + j1, f, (k + i1) * f1,
						(l + j1) * f2);
				tessellator.addVertexWithUV(i + i1, j + 0, f, (k + i1) * f1,
						(l + 0) * f2);
				tessellator.addVertexWithUV(i + 0, j + 0, f, (k + 0) * f1,
						(l + 0) * f2);
				tessellator.draw();
			}
