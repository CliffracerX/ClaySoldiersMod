...
public class RenderClayNexus extends RenderLiving implements Textures
	{
		...
		public void doRender(Entity par1Entity, double par2, double par4,
				double par6, float par8, float par9)
			{
				...
				mc1.isSpawnable =
						((EntityClayNexus) par1Entity).getColor() >= 0;
				
				super.doRender(par1Entity, par2, par4, par6, par8, par9);
			}
		
		protected int setCubeBrightness(EntityClayNexus par1EntityClayNexus,
				int par2, float par3)
			{
				if (par2 != 0)
					{
		 ...
		 */
		@Override
		protected int shouldRenderPass(EntityLivingBase par1EntityLiving,
				int par2, float par3)
			{
				return setCubeBrightness((EntityClayNexus) par1EntityLiving,
						par2, par3);
			}
