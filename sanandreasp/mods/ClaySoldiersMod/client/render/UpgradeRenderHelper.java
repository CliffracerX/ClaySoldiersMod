...
public class UpgradeRenderHelper
	{
		...
		public static void onRightItemRender(RightHandUpgrade upg,
				RenderManager manager, IUpgradeEntity entity, float partTicks,
				ModelBase model)
			{
				if (entity instanceof EntityClayMan
						&& model instanceof ModelClayMan)
					{
						...
						manager.itemRenderer.renderItem(kootra,
								upg.getHeldItem(entity), 0);
						GL11.glPopMatrix();
					}
			}
		...
		public static void onLeftItemRender(LeftHandUpgrade upg,
				RenderManager manager, IUpgradeEntity entity, float partTicks,
				ModelBase model)
			{
				if (entity instanceof EntityClayMan
		...
		public static void onShieldRender(LeftHandUpgrade upg,
				RenderManager manager, IUpgradeEntity entity, float partTicks,
				ModelBase model)
			{
				if (entity instanceof EntityClayMan
		...
		public static void onEggPreRender(UpgEggScent upg,
				RenderManager manager, IUpgradeEntity entity, float partTicks,
				ModelBase model)
			{
		...
		public static void onEggPostRender(UpgEggScent upg,
				RenderManager manager, IUpgradeEntity entity, float partTicks,
				ModelBase model)
			{
		...
		public static void onGlowPreRender(IUpgradeItem upg,
				RenderManager manager, IUpgradeEntity entity, float partTicks,
				ModelBase model)
			{
				// GL11.glEnable(GL11.GL_BLEND);
				...
				OpenGlHelper.setLightmapTextureCoords(
						OpenGlHelper.lightmapTexUnit, var6 / 1.0F, var7 / 1.0F);
		...
		public static void onGlowPostRender(IUpgradeItem upg,
				RenderManager manager, IUpgradeEntity entity, float partTicks,
				ModelBase model)
			{
