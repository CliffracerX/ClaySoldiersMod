...
public class ClientProxy extends CommonProxy
	{
		...
		public void registerRenderInformation()
			{
				RenderingRegistry.registerEntityRenderingHandler(
						EntityClayMan.class, new RenderClayMan(
								new ModelClayMan(0F, 13F), 0.125F));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityGravelChunk.class, new RenderGravelChunk());
				RenderingRegistry
						.registerEntityRenderingHandler(EntitySnowball.class,
								new RenderSnowball(Item.snowball));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityFireball.class, new RenderSnowball(
								Item.fireballCharge));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityHorse.class, new RenderHorse(new ModelHorse(0F,
								12.75F), 0.15F));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityPegasus.class, new RenderPegasus(
								new ModelPegasus(0F, 12.75F), 0.15F));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityBunny.class, new RenderBunny(new ModelBunny(),
								0.15F));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityTurtle.class, new RenderTurtle(new ModelTurtle(
								0F, 12.75F), 0.15F));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityGecko.class, new RenderGecko(new ModelGecko(),
								0.15F));
				RenderingRegistry.registerEntityRenderingHandler(
						EntityClayNexus.class, new RenderClayNexus(
								new ModelClayNexus(), 0.15F));
			}
				...
				switch (ID)
					{
						case 0:
							mc.effectRenderer.addEffect(new EntityDiggingFX(
									CSMModRegistry.proxy.getClientWorld(),
									(Double) data[0], (Double) data[1],
									(Double) data[2], (Double) data[0]
											- (Double) data[3] - 0.5D,
									(Double) data[1] - (Double) data[4] - 0.5D,
									(Double) data[2] - (Double) data[5] - 0.5D,
									(Block) data[6], rand.nextInt(6),
									(Integer) data[7]));
							break;
					}
			}
		...
		public void swingSoldierArm(byte[] data, Player player)
			{
				WorldClient world =
						(WorldClient) ((EntityPlayer) player).worldObj;
				Entity entity =
						world.getEntityByID(getEntityIdFromByteArray(data));
		...
		public void spawnEntityParticles(byte[] data, Player player)
			{
				...
				switch (data[5])
					{
						case 0:
							mc.effectRenderer.addEffect(new EntityNoteFX(world,
									entity.posX, entity.posY + 0.5D,
									entity.posZ, rand.nextFloat(), rand
											.nextFloat(), rand.nextFloat()));
							break;
						case 1:
							Vec3 vec3d =
									Vec3.createVectorHelper(
											(rand.nextFloat() - 0.5D) * 0.10000000000000001D,
							...
							Vec3 vec3d1 =
									Vec3.createVectorHelper(
											(rand.nextFloat() - 0.5D) * 0.29999999999999999D,
											(-rand.nextFloat()) * 0.59999999999999998D - 0.29999999999999999D,
							...
							vec3d1 =
									vec3d1.addVector(entity.posX, entity.posY
											+ entity.getEyeHeight(),
											entity.posZ);
							world.spawnParticle(
									(new StringBuilder()).append("iconcrack_")
											.append(Item.porkRaw.itemID)
											.toString(), vec3d1.xCoord,
									vec3d1.yCoord, vec3d1.zCoord, vec3d.xCoord,
						...
						case 2:
							...
							// color =
							// ((EntityClayMan)entity).teamCloth(((EntityClayMan)entity).getClayTeam());
							...
							double c =
									entity.posZ
											+ ((rand.nextFloat() - rand
													.nextFloat()) * 0.125D);
							//
							// mc.effectRenderer.addEffect((new
							// EntityDiggingFX(world, a, b, c, 0.0D, 0.0D, 0.0D,
							// Block.cloth, 0, color)));
							break;
						case 3:
							a =
						...
						case 8:
							...
							break;
						case 9:
							mc.effectRenderer.addEffect(new EntityCrit2FX(
									world, entity));
							break;
						case 10:
							EntityClayNexus nexus = (EntityClayNexus) entity;
							mc.effectRenderer.addEffect(new EntityNexusFX(
									world, nexus.posX
											+ (rand.nextDouble() - 0.5D)
											* nexus.width,
									(nexus.posY + rand.nextDouble()
											* nexus.height) - 0.25D, nexus.posZ
											+ (rand.nextDouble() - 0.5D)
											* nexus.width,
									(rand.nextDouble() - 0.5D) * 2D, -rand
											.nextDouble(),
									(rand.nextDouble() - 0.5D) * 2D, nexus
											.getTeamColor()[0], nexus
											.getTeamColor()[1], nexus
											.getTeamColor()[2]));
							break;
						case 11:
							...
							mc.effectRenderer
									.addEffect(new EntityDiggingFX(
											CSMModRegistry.proxy
													.getClientWorld(), a, b, c,
											0.0D, 0.0D, 0.0D, Block.gravel, 0,
											0));
							break;
						case 13:
							a =
							...
							c =
									entity.posZ
											+ ((rand.nextFloat() - rand
													.nextFloat()) * 0.125D);
							mc.effectRenderer.addEffect(new EntityDiggingFX(
									CSMModRegistry.proxy.getClientWorld(), a,
									b, c, 0.0D, 0.0D, 0.0D, Block.dirt, 0, 0));
							break;
						case 14:
							world.spawnParticle("reddust", entity.posX,
									entity.posY + 0.5F, entity.posZ, -0.4F, 1F,
									0F);
							break;
						case 15:
							world.spawnParticle("reddust", entity.posX,
									entity.posY + 0.5F, entity.posZ, -1F, 0F,
									0F);
							break;
						case 16:
							for (int j = 0; j < 4; j++)
								{
									...
									c =
											entity.posZ
													+ ((rand.nextFloat() - rand
															.nextFloat()) * 0.125D);
									world.spawnParticle("reddust", a, b, c,
											0.0D, 0.8D, 0.0D);
								}
							break;
						case 17:
							...
							break;
						case 18:
							world.spawnParticle("flame", entity.posX,
									entity.posY + 0.1D, entity.posZ, 0.0D,
									0.01D, 0.0D);
							break;
						case 19:
							world.spawnParticle("heart", entity.posX,
									entity.posY + 0.1D, entity.posZ, 0.0D,
									0.01D, 0.0D);
							break;
						case 20:
							for (int j = 0; j < 4; j++)
								{
									...
									c =
											entity.posZ
													+ ((rand.nextFloat() - rand
															.nextFloat()) * 0.125D);
									world.spawnParticle("slime", a, b, c, 0.0D,
											0.1D, 0.0D);
								}
							break;
						case 21:
							world.spawnParticle("portal",
									entity.posX + (rand.nextDouble() - 0.5D)
											* entity.width * 0.5D,
									(entity.posY + rand.nextDouble()
											* entity.height) - 0.05D,
									entity.posZ + (rand.nextDouble() - 0.5D)
											* entity.width * 0.5D,
									(rand.nextDouble() - 0.5D) * 0.75D,
									-rand.nextDouble() * 0.5D,
									(rand.nextDouble() - 0.5D) * 0.75D);
							break;
					}
				...
				if (CSMModRegistry.prevPlayer != null)
					{
						...
						game.gameSettings.thirdPersonView =
								(CSMModRegistry.showTheGUY ? 0 : 1);
						CSMModRegistry.claycam.setDead();
						for (int i = 0; i < game.theWorld.playerEntities.size(); i++)
							{
								if (game.theWorld.playerEntities.get(i).equals(
										CSMModRegistry.claycam))
