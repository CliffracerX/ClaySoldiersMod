		...
		public void setRotationAngles(float f, float f1, float f2, float f3,
				float f4, float f5, Entity e)
			{
				...
				bipedLeftArm.rotateAngleX =
						MathHelper.cos(f * 0.6662F) * 2.0F * f1 * 0.25F;
				bipedRightArm.rotateAngleZ = 0.0F;
				bipedLeftArm.rotateAngleZ = 0.0F;
				bipedRightLeg.rotateAngleX =
						MathHelper.cos(f * 0.6662F) * 0.5F * f1;
				bipedLeftLeg.rotateAngleX =
						MathHelper.cos(f * 0.6662F + 3.141593F) * 0.5F * f1;
				...
				bipedTail.rotateAngleX =
						0.3F + (bipedRightArm.rotateAngleX * bipedRightArm.rotateAngleX);
				bipedMane.rotateAngleX = bipedNeck.rotateAngleX = -0.6F;
				
				bipedEar1.rotateAngleX =
						bipedEar2.rotateAngleX = bipedHead.rotateAngleX;
				bipedEar1.rotateAngleY =
						bipedEar2.rotateAngleY = bipedHead.rotateAngleY;
			}
