...
public class ModelClayMan extends ModelBiped
	{
				...
				if (hasArmor)
					{
						...
						if (isPadded)
							{
								GL11.glPushMatrix();
								GL11.glColor3f(colorPadded[0], colorPadded[1],
										colorPadded[2]);
				...
				if (isSuper || isCaped)
					{
						...
						if (isSuper)
							...
							{
								GL11.glColor3f(capePadded[0], capePadded[1],
										capePadded[2]);
							}
						bipedCape.render(f5);
						GL11.glColor3f(1F, 1F, 1F);
		...
		public void setRotationAngles(float f, float f1, float f2, float f3,
				float f4, float f5, Entity entity)
			{
				...
				bipedRightArm.rotateAngleX =
						MathHelper.cos(f * 0.6662F + 3.141593F) * 2.0F * f1
								* 0.5F;
				...
				if (heldItemLeft != 0)
					{
						bipedLeftArm.rotateAngleX =
								bipedLeftArm.rotateAngleX * 0.5F - 0.3141593F;
					}
				if (heldItemRight != 0)
					{
						bipedRightArm.rotateAngleX =
								bipedRightArm.rotateAngleX * 0.5F - 0.3141593F;
					}
				...
				// Customs
				bipedStrap.rotateAngleX =
						bipedGoggle2.rotateAngleX =
								bipedGoggle.rotateAngleX =
										speckyHead.rotateAngleX =
												bipedHead.rotateAngleX;
				bipedStrap.rotateAngleY =
						bipedGoggle2.rotateAngleY =
								bipedGoggle.rotateAngleY =
										speckyHead.rotateAngleY =
												bipedHead.rotateAngleY;
				
				bipedChest2.rotateAngleY =
						bipedPadding.rotateAngleY =
								bipedChest.rotateAngleY =
										speckyBody.rotateAngleY =
												bipedBody.rotateAngleY;
				
				// stickBlaze.rotateAngleX =
				stickBlunt.rotateAngleX =
						stickSharp.rotateAngleX =
								stick.rotateAngleX =
										bipedRightPadding.rotateAngleX =
												bipedRightArmor.rotateAngleX =
														speckyRightArm.rotateAngleX =
																bipedRightArm.rotateAngleX;
				// stickBlaze.rotateAngleY =
				stickBlunt.rotateAngleY =
						stickSharp.rotateAngleY =
								stick.rotateAngleY =
										bipedRightPadding.rotateAngleY =
												bipedRightArmor.rotateAngleY =
														speckyRightArm.rotateAngleY =
																bipedRightArm.rotateAngleY;
				// stickBlaze.rotateAngleZ =
				stickBlunt.rotateAngleZ =
						stickSharp.rotateAngleZ =
								stick.rotateAngleZ =
										bipedRightPadding.rotateAngleZ =
												bipedRightArmor.rotateAngleZ =
														speckyRightArm.rotateAngleZ =
																bipedRightArm.rotateAngleZ;
				
				bipedRock.rotateAngleX =
						bipedLeftPadding.rotateAngleX =
								bipedLeftArmor.rotateAngleX =
										speckyLeftArm.rotateAngleX =
												bipedLeftArm.rotateAngleX;
				bipedRock.rotateAngleY =
						bipedLeftPadding.rotateAngleY =
								bipedLeftArmor.rotateAngleY =
										speckyLeftArm.rotateAngleY =
												bipedLeftArm.rotateAngleY;
				bipedRock.rotateAngleZ =
						bipedLeftPadding.rotateAngleZ =
								bipedLeftArmor.rotateAngleZ =
										speckyLeftArm.rotateAngleZ =
												bipedLeftArm.rotateAngleZ;
				
				RightLegArmor.rotateAngleX =
						speckyRightLeg.rotateAngleX =
								bipedRightLeg.rotateAngleX;
				RightLegArmor.rotateAngleY =
						speckyRightLeg.rotateAngleY =
								bipedRightLeg.rotateAngleY;
				RightLegArmor.rotateAngleZ =
						speckyRightLeg.rotateAngleZ =
								bipedRightLeg.rotateAngleZ;
				
				LeftLegArmor.rotateAngleX =
						speckyLeftLeg.rotateAngleX = bipedLeftLeg.rotateAngleX;
				LeftLegArmor.rotateAngleY =
						speckyLeftLeg.rotateAngleY = bipedLeftLeg.rotateAngleY;
				LeftLegArmor.rotateAngleZ =
						speckyLeftLeg.rotateAngleZ = bipedLeftLeg.rotateAngleZ;
		...
		public boolean hasStick, hasArmor, hasCrown, hasSpecks, isClimbing,
				isSharpened, isPadded, isGooey, hasLogs, holdFeather, hasRocks,
				hasGoggles, isSuper, hasBlazeRod, isCaped, hasPants;
		public int sittingPos = 0;
		public float colorPadded[] = new float[]
			{
					1.0F, 1.0F, 1.0F
			};
		public float capePadded[] = new float[]
			{
					1.0F, 1.0F, 1.0F
			};
	}
