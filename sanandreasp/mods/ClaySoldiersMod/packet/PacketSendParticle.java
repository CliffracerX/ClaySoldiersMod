...
public class PacketSendParticle
	{
		...
		public static void sendParticle(int i, int dimID, double posX,
				double posY, double posZ, Double dataI, Double dataII,
				Double dataIII)
			{
				...
				try
				...
				catch (IOException e)
					{
						FMLLog.log(CSMModRegistry.modID, Level.WARNING, e,
								"Failed to send packet PacketSendParticle to players!");
					}
			}
	}
